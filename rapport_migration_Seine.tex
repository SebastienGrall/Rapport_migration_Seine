...
filecolor=blue, 
urlcolor=blue, 
pdftitle= {Suivi des poissons migrateurs sur les stations de contrôle des migrations (STACOMI) du bassin de la Seine\\ Année 2024 }, pdfauthor={Sébastien Grall},
pdfsubject={stacomi},
...
\fancyhf{}
\rhead{\rightmark}
\lfoot{\footnotesize{Suivi des poissons migrateurs sur les stations de contrôle des migrations (STACOMI) du bassin de la Seine, année 2024}} %Insere un pied de page avec le texte a gauche.
\rfoot{\thepage}
...
\caption{Régime hydrologique de la Seine à Vernon, la moyenne interannuelle des dix années précédentes (2013 à 2023) est représentée en bleu, les débits journaliers de l'année sont présentés en noir}
