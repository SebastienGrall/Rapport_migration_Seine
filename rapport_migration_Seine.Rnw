...
png(file=str_c(imgwd,"plot_annuel_ala.png"),width=10,height=5,unit="in",res=200)
...
png(file=str_c(imgwd,"plot_ridgeline_ala.png"),width=10,height=5,unit="in",res=200)
...
png(file=str_c(imgwd,"p_seasonal_ala.png"),width=10,height=8,unit="in",res=200)
