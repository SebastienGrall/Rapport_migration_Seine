...
# data alose 
r_mig_inter_ala_poses_rg<-fn_rmiginter(le_dc=c(101),espece=c("Alosa"),stade=c("5"),annee_debut = 2008)
r_mig_inter_ala_poses_rd<-fn_rmiginter(le_dc=c(103,105),espece=c("Alosa"),stade=c("5"),annee_debut = 2018)
...
data_alose<-c(r_mig_inter_ala_poses_rg,r_mig_inter_ala_poses_rd,r_mig_inter_ala_carandeau,r_mig_inter_ala_pontoise)
rm(r_mig_inter_ala_poses_rg,r_mig_inter_ala_poses_rd,r_mig_inter_ala_carandeau,r_mig_inter_ala_pontoise)
...
r_mig_inter_ang_poses_rg_video_agj<-fn_rmiginter(le_dc=c(101),espece=c("Anguilla anguilla"),stade=c("4"),annee_debut = 2008)
r_mig_inter_ang_poses_rg_video_agg<-fn_rmiginter(le_dc=c(101),espece=c("Anguilla anguilla"),stade=c("AGG"),annee_debut = 2008)
r_mig_inter_ang_poses_rd_video_agj<-fn_rmiginter(le_dc=c(103,105),espece=c("Anguilla anguilla"),stade=c("4"),annee_debut = 2018)
r_mig_inter_ang_poses_rd_video_agg<-fn_rmiginter(le_dc=c(103,105),espece=c("Anguilla anguilla"),stade=c("AGG"),annee_debut = 2018)
...
data_ang<-c(r_mig_inter_ang_poses_rg_piege,
                ...
                r_mig_inter_ang_poses_rg_video_agj,
                r_mig_inter_ang_poses_rg_video_agg,
                r_mig_inter_ang_poses_rd_video_agj,
                r_mig_inter_ang_poses_rd_video_agg,
...
r_mig_inter_lpf_poses_rg<-fn_rmiginter(le_dc=c(101),espece=c("Lampetra fluviatilis"),stade=c("5"),annee_debut = 2008)
r_mig_inter_lpf_poses_rd<-fn_rmiginter(le_dc=c(103,105),espece=c("Lampetra fluviatilis"),stade=c("5"),annee_debut = 2018)

data_lpf<-c(r_mig_inter_lpf_poses_rg,r_mig_inter_lpf_poses_rd)
rm(r_mig_inter_lpf_poses_rg,r_mig_inter_lpf_poses_rd)

#data lamproie marine
r_mig_inter_lpm_poses_rg<-fn_rmiginter(le_dc=c(101),espece=c("Petromyzon marinus"),stade=c("5"),annee_debut = 2008)
r_mig_inter_lpm_poses_rd<-fn_rmiginter(le_dc=c(103,105),espece=c("Petromyzon marinus"),stade=c("5"),annee_debut = 2018)
...
data_lpm<-c(r_mig_inter_lpm_poses_rg,r_mig_inter_lpm_poses_rd,r_mig_inter_lpm_carandeau_P1,r_mig_inter_lpm_pontoise)
rm(r_mig_inter_lpm_poses_rg,r_mig_inter_lpm_poses_rd,r_mig_inter_lpm_carandeau_P1,r_mig_inter_lpm_pontoise)

#data mulet porc
r_mig_inter_mup_poses_rg<-fn_rmiginter(le_dc=c(101),espece=c("Chelon ramada"),stade=c("5"),annee_debut = 2008)
r_mig_inter_mup_poses_rd<-fn_rmiginter(le_dc=c(103,105),espece=c("Chelon ramada"),stade=c("5"),annee_debut = 2018)

data_mup<-c(r_mig_inter_mup_poses_rg,r_mig_inter_mup_poses_rd)
rm(r_mig_inter_mup_poses_rg,r_mig_inter_mup_poses_rd)

#data sat
r_mig_inter_sat_poses_rg<-fn_rmiginter(le_dc=c(101),espece=c("Salmo salar"),stade=c("5"),annee_debut = 2008)
r_mig_inter_sat_poses_rd<-fn_rmiginter(le_dc=c(103,105),espece=c("Salmo salar"),stade=c("5"),annee_debut = 2018)
...
data_sat<-c(r_mig_inter_sat_poses_rg,r_mig_inter_sat_poses_rd,r_mig_inter_sat_carandeau,r_mig_inter_sat_pontoise)
rm(r_mig_inter_sat_poses_rg,r_mig_inter_sat_poses_rd,r_mig_inter_sat_carandeau,r_mig_inter_sat_pontoise)

#data trm
r_mig_inter_trm_poses_rg<-fn_rmiginter(le_dc=c(101),espece=c("Salmo trutta trutta"),stade=c("5"),annee_debut = 2008)
r_mig_inter_trm_poses_rd<-fn_rmiginter(le_dc=c(103,105),espece=c("Salmo trutta trutta"),stade=c("5"),annee_debut = 2018)
...
data_trm<-c(r_mig_inter_trm_poses_rg,r_mig_inter_trm_poses_rd,r_mig_inter_trm_carandeau,r_mig_inter_trm_pontoise)
rm(r_mig_inter_trm_poses_rg,r_mig_inter_trm_poses_rd,r_mig_inter_trm_carandeau,r_mig_inter_trm_pontoise)
...
resume_latex <- resume2 %>%
  kbl(
    caption = "Effectifs annuels des poissons migrateurs",
    booktabs = TRUE,
    format = "latex",
    escape = FALSE,
    linesep = ""
